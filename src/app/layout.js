...
export const metadata = {
  ...
  description: "Kaeluma is a growing set of apps for the household: Quests for routines, Vital for health, Ledger for money, Table for meals, one login for everyone. Free and ad-free.",
...
export default function RootLayout({ children }) {
  const jsonLdSchema = {
    ...
    "description": "Kaeluma is a family of free apps for the household — Quests for routines, Vital for health, Ledger for money, and Table for meals.",
    "featureList": [
      ...
      "Table household meals: weekly plan and grocery list",
