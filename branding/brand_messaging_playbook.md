...
```mermaid
graph TD
    A[Kaeluma Target Personas] --> B[The Overwhelmed Parent]
    A --> C[The Tech-Forward Parent]
    A --> D[The Gamer Child]
    
    B --> B1["Focus: Routine Peace & Less Nagging"]
    C --> C1["Focus: Digital Literacy & earned Screen-Time"]
    D --> D1["Focus: Autonomy & Leveling Up"]
```
